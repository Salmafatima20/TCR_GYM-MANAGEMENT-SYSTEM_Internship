...
(id int, name varchar(50), category varchar(50), fess int);

DESC fee_trainer;
SELECT * FROM fee_trainer ;

CREATE TABLE pay_customer
(RecepitNo int, name varchar(50),category varchar(50), fess float, month varchar(50), FirstName varchar(50));
